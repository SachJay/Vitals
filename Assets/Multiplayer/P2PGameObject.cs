...
{
    List<byte[]> CachedMessages;
    List<byte[]> thingsThatFailedToHandle;
    List<byte[]> thingsThatFailedToSend;
    List<byte[]> retryQueueForThingsThatFailedToSend;
    List<byte[]> retryQueueForThingsThatFailedToHandle;
    SteamId opponentSteamId;
