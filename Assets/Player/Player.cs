...
public class Player : MonoBehaviour
{
    ...
    [SerializeField]
    ParticleSystem impactParticleEffects;

    [SerializeField]
    AudioSource attackImpactSoundEffect;

    [SerializeField]
    AudioSource swingSoundEffect;

    [SerializeField]
    AudioSource dashSoundEffect;
